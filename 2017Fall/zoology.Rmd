...
- use the green plus in upper right, or `File`->`New File` to create an `R Script`. 
...
Hard to follow patterns, as species are ordered alphabetically by name. 
Below we reorder by mean weight. Notice the subtle differences evident now between males and females.
