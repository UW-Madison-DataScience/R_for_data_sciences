...
* [characters and strings](curate/string.html)
* [regular expressions (regex)](curate/regex.html)

## Create Functions to Collapse Steps

[examples of functions](curate/function.html)

## Save Cleaned up Data to External Files

[read and write files](curate/file.html)
